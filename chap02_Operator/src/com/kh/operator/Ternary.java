...
public class Ternary {
	...
	public static void main(String[] args) {
		...
		int num1 = 7;
		String num2 = (num1 % 2 ==0) ? "짝수" : "홀수";
		System.out.println("7의 값은 짝수인가 홀수인가 : " + num2);
		
		
		int number2 = -5;
		String sign2 = (number2 > 0) ? "양수" : (number2 < 0) ? "음수" : "영";//왼쪽에서 조건에 맞는지 확인하며 진행
		System.out.println("숫자의 부호 : " + sign);
